...
const About = () => (
  <div className="aboutContainer">
    <div className="marginTopBot paddingOnSides floatItLeft spaceBot paddingTop zIndexHigh">
      ...
      <p className="textParagraphs">O Pride Hack acontece nos dias <b>23 e 24 de novembro, a partir das 8h horas, no CIn-UFPE</b>. O evento é aberto para todos, basta preencher o <b className="boldIt"><a className="redHref" target="_blank" href="http://bit.ly/inscricao-pridehack">formulário de inscrição</a></b>   e quando o resultado sair nós te avisaremos.</p>
    </div>
  </div>
)
